...
const socialLinks = [
  ...
  },
  {
    href: "#!instagram.com",
    value:
      '<svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24" fill="#E4405F"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.334 3.608 1.308.974.975 1.246 2.242 1.308 3.608.058 1.266.069 1.646.069 4.851s-.011 3.584-.069 4.85c-.062 1.366-.334 2.633-1.308 3.608-.975.974-2.242 1.246-3.608 1.308-1.266.058-1.646.069-4.85.069s-3.584-.011-4.85-.069c-1.366-.062-2.633-.334-3.608-1.308-.974-.975-1.246-2.242-1.308-3.608-.058-1.266-.069-1.646-.069-4.85s.011-3.584.069-4.851c.062-1.366.334-2.633 1.308-3.608.975-.974 2.242-1.246 3.608-1.308 1.266-.058 1.646-.069 4.85-.069m0-2.163c-3.259 0-3.667.014-4.947.072-1.281.058-2.556.337-3.637 1.418-1.081 1.081-1.36 2.356-1.418 3.637-.058 1.28-.072 1.688-.072 4.947s.014 3.667.072 4.947c.058 1.281.337 2.556 1.418 3.637 1.081 1.081 2.356 1.36 3.637 1.418 1.28.058 1.688.072 4.947.072s3.667-.014 4.947-.072c1.281-.058 2.556-.337 3.637-1.418 1.081-1.081 1.36-2.356 1.418-3.637.058-1.28.072-1.688.072-4.947s-.014-3.667-.072-4.947c-.058-1.281-.337-2.556-1.418-3.637-1.081-1.081-2.356-1.36-3.637-1.418-1.28-.058-1.688-.072-4.947-.072zM12 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zm0 10.162a3.999 3.999 0 1 1 0-7.998 3.999 3.999 0 0 1 0 7.998zm6.406-11.845a1.44 1.44 0 1 0 0 2.882 1.44 1.44 0 0 0 0-2.882z"/></svg>',
  },
  {
    href: "#!whatsapp.com",
    value:
